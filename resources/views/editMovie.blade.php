...
<body class="flex flex-col gap-64 h-screen justify-center items-center">
    ...
    <form method="POST" action="/admin/movies/{{ $movie->id }}" class="flex items-center w-2/12">
        ...
        <div class="flex flex-col gap-8 w-full">
            ...
            <button type="submit"
                class="bg-white text-black uppercase font-bold text-2xl py-2 px-10 rounded-2xl hover:bg-gray-500 hover:text-white w-1/2 self-center mt-12 shadow-md">Update
                name
            </button>
        </div>
